...
export const Proposal = () => {
    return (
        <>
            <section className="flex flex-col bg-white h-full w-full md:items-center mx-auto md:max-w-3xl lg:max-w-5xl xl:max-w-6xl">
                <h1 className="text-2xl font-bold py-6 flex justify-center md:text-4xl md:py-20">Por que ser Premium?</h1>

                <ul className="flex flex-col items-start md:grid grid-cols-2 gap-6 xl:grid-cols-4">

                    <li className="ml-4 h-36 flex gap-4 md:w-360px lg:w-470px xl:w-285px xl:flex-col xl:items-center xl:text-center xl:h-285px xl:m-0">
